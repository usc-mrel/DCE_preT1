...
switch pattern
    case 0
        matname = ['../results/25/SP_rect_R' num2str(R) '_re' num2str(realization) '.mat'];
    case 1
        matname = ['../results/25/SP_ellip_R' num2str(R) '_re' num2str(realization) '.mat'];
    case 2
        matname = ['../results/25/RGA_ellip_R' num2str(R) '_re' num2str(realization) '.mat'];
    case 3
        matname = ['../results/25/RGA_rect_R' num2str(R) '_re' num2str(realization) '.mat'];
end
